...
public class SinglyLinkedList<KVdata extends Comparable<KVdata>> {
    Node<KVdata> head;
...
//        return false;
    ...
    public SinglyLinkedList<KVdata> copy() {
        if (head == null) return null;

        SinglyLinkedList<KVdata> copy = new SinglyLinkedList<KVdata>();
    ...
    public SinglyLinkedList<KVdata> sortASC(SinglyLinkedList<KVdata> list) {
    ...
    public SinglyLinkedList<KVdata> sortDESC(SinglyLinkedList<KVdata> list) {
        Node<KVdata> prevNode = list.head;
        Node<KVdata> current = prevNode.next;
        Node<KVdata> temp = new Node<KVdata>(head.data);
        for (int i = 0; i < list.size() ; i++){
